...
async def create_comment(db: Session, comment: CommentBase, user_id: int, photo_id: int) -> Comment:
...
async def edit_comment(db: Session, comment_id: int, new_text: str) -> Optional[Comment]:

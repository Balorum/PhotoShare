...
async def create_photo(
    ...
    r = cloudinary.uploader.upload(
        file.file, public_id=f"PhotoShareApp/user", overwrite=True
    )  # Коли буде функціонал, вказати конкретного юзера
    src_url = cloudinary.CloudinaryImage(f"PhotoShareApp/user").build_url(

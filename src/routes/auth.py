...
from src.schemas.users import UserModel, UserResponse, TokenSchema, RequestEmail
...
async def signup(body: UserModel, background_tasks: 
                 BackgroundTasks, request: Request, db: Session = Depends(get_db)):
    """
